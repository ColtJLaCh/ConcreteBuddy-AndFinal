...
public class CustomViewPageAdapter extends FragmentStateAdapter {
    ...
    public Fragment createFragment(int position) {
        switch(position) {
            ...
            case 2: return VPTipsFragment.newInstance(position+1,"More Hands!",R.drawable.construction,"Although it may seem easier to just do it all yourself...\n\nHaving multiple people there to assist you will speed up the progress, \nand makes it more likely you get your concrete set properly!\n\nThese are especially when using ready-mix concrete.");
